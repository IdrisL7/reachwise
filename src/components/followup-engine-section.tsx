...
const bullets = [
  {
    ...
    description:
      "Export hooks + evidence anywhere. We layer on top of your existing stack — no migration, no lock-in.",
  },
  {
    icon: (
      <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    description:
      "VP Sales vs RevOps vs Founder — pick the role and hooks are framed for that buyer's priorities, so relevance lands fast.",
  },
  {
    icon: (
      <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    description:
      "Quote + source + date on every message. Your SDRs can defend what they send because every claim traces back to a real public signal.",
  },
  {
    icon: (
      <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    description:
      "Approvals, daily caps, stop-on-reply, auto-pause on OOO/bounce, and a full audit trail. Autonomous with guardrails — not a black box.",
  },
];
