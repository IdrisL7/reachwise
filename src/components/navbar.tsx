...
export function Navbar() {
  ...
  return (
    <motion.nav
      className="sticky top-0 z-50 border-b border-white/[0.06] bg-[#0a0a0b]/95"
        ...
        <div className="hidden sm:flex items-center gap-8">
          ...
          {isLoggedIn ? (
            <>
              <Link
                href="/app/hooks"
                className="bg-violet-600 text-white h-9 px-4 rounded-lg text-sm font-semibold inline-flex items-center focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-violet-500 focus-visible:ring-offset-2 focus-visible:ring-offset-[#080808]"
              >
                Open app
              </Link>
